...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.32]{FigurasUV/1.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.32]{FigurasUV/varexp.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.39]{FigurasUV/2.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.32]{FigurasUV/4.pdf}
  \caption{Representación de los individuos}\label{figura1}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.32]{FigurasUV/5.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.32]{FigurasUV/6.pdf}
