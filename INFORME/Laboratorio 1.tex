...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.39]{FigurasUV/1.pdf}
...
\begin{figure}[h]
  ...
  \caption{Círculo de correlaciones para la tabla de importaciones generado por las dos
primeras componentes principales}\label{figura1}
\end{figure}

\item Representación de los individuos en el primer plano factorial:
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.39]{FigurasUV/4.pdf}
  \caption{Representación de los individuos}\label{figura1}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.39]{FigurasUV/5.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.39]{FigurasUV/varexp.pdf}
